...
public class RobotMap {
  ...
  public static final int
    ...
    ROCKET_CARGO_1 = (int)(27.25+3-MINIMUM_HEIGHT_INCHES)*TICKS_PER_INCH,
    ROCKET_CARGO_2 = (int)((27.25+28+3)-MINIMUM_HEIGHT_INCHES)*TICKS_PER_INCH,
    // ROCKET_CARGO_3 = (int)((27.25+28+28+3)-MINIMUM_HEIGHT_INCHES)*TICKS_PER_INCH,	
    ROCKET_CARGO_3 = MAXIMUM_ELEVATOR_HEIGHT_TICKS,

    CARGOSHIP_CARGO = (43-MINIMUM_HEIGHT_INCHES)*TICKS_PER_INCH,

    CARGO_LOADING_STATION_HEIGHT = (47-MINIMUM_HEIGHT_INCHES)*TICKS_PER_INCH
  ;
